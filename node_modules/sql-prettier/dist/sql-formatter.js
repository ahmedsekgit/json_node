...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Db2Formatter = __webpack_require__(38);

	var _Db2Formatter2 = _interopRequireDefault(_Db2Formatter);

	var _N1qlFormatter = __webpack_require__(39);

	var _N1qlFormatter2 = _interopRequireDefault(_N1qlFormatter);

	var _PlSqlFormatter = __webpack_require__(40);

	var _PlSqlFormatter2 = _interopRequireDefault(_PlSqlFormatter);

	var _StandardSqlFormatter = __webpack_require__(41);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _trimEnd = __webpack_require__(33);

	var _trimEnd2 = _interopRequireDefault(_trimEnd);

	var _tokenTypes = __webpack_require__(15);

	var _tokenTypes2 = _interopRequireDefault(_tokenTypes);

	var _Indentation = __webpack_require__(35);

	var _Indentation2 = _interopRequireDefault(_Indentation);

	var _InlineBlock = __webpack_require__(36);

	var _InlineBlock2 = _interopRequireDefault(_InlineBlock);

	var _Params = __webpack_require__(37);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _escapeRegExp = __webpack_require__(107);
	...
	var Tokenizer = function () {
	     ...
	     *  @param {String[]} cfg.openCondition Openning condition statement, like CASE
	     *  @param {String[]} cfg.closeCondition Closing condition statement, like END
	     *  @param {String[]} cfg.conditionWords condition statement key words, like ELSE
	     */
	    function Tokenizer(cfg) {
	        ...
	        this.OPEN_CONDITION_REGEX = this.createParenRegex(cfg.openCondition);
	        this.CONDITION_WORDS_REGEX = this.createReservedWordRegex(cfg.conditionWords);
	        this.CLOSE_CONDITION_REGEX = this.createParenRegex(cfg.closeCondition);
	    ...
	    Tokenizer.prototype.getNextToken = function getNextToken(input, previousToken) {
	        return this.getWhitespaceToken(input) || this.getCommentToken(input) || this.getStringToken(input) || this.getOpenParenToken(input) || this.getCloseParenToken(input) || this.getOpenConditionToken(input) || this.getConditionWordsToken(input) || this.getCloseConditionToken(input) || this.getPlaceholderToken(input) || this.getNumberToken(input) || this.getReservedWordToken(input, previousToken) || this.getWordToken(input) || this.getOperatorToken(input);
	    };
	    ...
	    Tokenizer.prototype.getOpenConditionToken = function getOpenConditionToken(input) {
	        return this.getTokenOnFirstMatch({
	            input: input,
	            type: _tokenTypes2["default"].OPEN_CONDITION,
	            regex: this.OPEN_CONDITION_REGEX
	        });
	    };

	    Tokenizer.prototype.getCloseConditionToken = function getCloseConditionToken(input) {
	        return this.getTokenOnFirstMatch({
	            input: input,
	            type: _tokenTypes2["default"].CLOSE_CONDITION,
	            regex: this.CLOSE_CONDITION_REGEX
	        });
	    };

	    Tokenizer.prototype.getConditionWordsToken = function getConditionWordsToken(input) {
	        return this.getTokenOnFirstMatch({
	            input: input,
	            type: _tokenTypes2["default"].CONDITION_WORDS,
	            regex: this.CONDITION_WORDS_REGEX
	        });
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _upperCase = __webpack_require__(120);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseToString = __webpack_require__(21),
	    castSlice = __webpack_require__(66),
	    charsEndIndex = __webpack_require__(67),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _repeat = __webpack_require__(115);

	var _repeat2 = _interopRequireDefault(_repeat);

	var _last = __webpack_require__(113);

	var _last2 = _interopRequireDefault(_last);

	var _get = __webpack_require__(108);
	...
	var InlineBlock = function () {
	    ...
	    InlineBlock.prototype.isInlineBlock = function isInlineBlock(tokens, index) {
	        ...
	        for (var i = index; i < tokens.length; i++) {
	            var token = tokens[i];
	            length += (0, _trimEnd2["default"])(token.value).length;
	    ...
	    InlineBlock.prototype.isSubQuery = function isSubQuery(tokens, index) {
	        var i = index - 1;
	        var wordBeforeBracket = tokens[i];
	        // 避免无聊的用括号一直包。。导致不想要的格式化异常
	        while (wordBeforeBracket && [_tokenTypes2["default"].OPEN_PAREN, _tokenTypes2["default"].WHITESPACE].includes(wordBeforeBracket.type)) {
	            i = i - 1;
	    ...
	    InlineBlock.prototype.isForbiddenToken = function isForbiddenToken(_ref) {
	        ...
	        return value === "SELECT" || type === _tokenTypes2["default"].RESERVED_TOPLEVEL ||
	        // type === tokenTypes.RESERVED_NEWLINE ||
	        type === _tokenTypes2["default"].COMMENT || type === _tokenTypes2["default"].BLOCK_COMMENT || value === ";";
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Formatter = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _uniqueId2 = __webpack_require__(119);
	...
	var reservedWords = ["ACCESSIBLE", "ACTION", "ADD", "AGAINST", "AGGREGATE", "ALGORITHM", "ALL", "ALTER", "ANALYSE", "ANALYZE", "AS", "ASC", "AUTOCOMMIT", "AUTO_INCREMENT", "BACKUP", "BEGIN", "BETWEEN", "BINLOG", "BOTH", "CASCADE", "CASE", "CHANGE", "CHANGED", "CHARACTER SET", "CHARSET", "CHECK", "CHECKSUM", "COLLATE", "COLLATION", "COLUMN", "COLUMNS", "COMMENT", "COMMIT", "COMMITTED", "COMPRESSED", "CONCURRENT", "CONSTRAINT", "CONTAINS", "CONVERT", "CREATE", "CROSS", "CURRENT_TIMESTAMP", "DATABASE", "DATABASES", "DAY", "DAY_HOUR", "DAY_MINUTE", "DAY_SECOND", "DEFAULT", "DEFINER", "DELAYED", "DELETE", "DESC", "DESCRIBE", "DETERMINISTIC", "DISTINCT", "DISTINCTROW", "DIV", "DO", "DROP", "DUMPFILE", "DUPLICATE", "DYNAMIC", "ENCLOSED", "END", "ENGINE", "ENGINES", "ENGINE_TYPE", "ESCAPE", "ESCAPED", "EVENTS", "EXEC", "EXECUTE", "EXISTS", "EXPLAIN", "EXTENDED", "FAST", "FETCH", "FIELDS", "FILE", "FIRST", "FIXED", "FLUSH", "FOR", "FORCE", "FOREIGN", "FULL", "FULLTEXT", "FUNCTION", "GLOBAL", "GRANT", "GRANTS", "GROUP_CONCAT", "HEAP", "HIGH_PRIORITY", "HOSTS", "HOUR", "HOUR_MINUTE", "HOUR_SECOND", "IDENTIFIED", "IF", "IFNULL", "IGNORE", "IN", "INDEX", "INDEXES", "INFILE", "INSERT", "INSERT_ID", "INSERT_METHOD", "INTERVAL", "INTO", "INVOKER", "IS", "ISOLATION", "KEY", "KEYS", "KILL", "LAST_INSERT_ID", "LEADING", "LEVEL", "LIKE", "LINEAR", "LINES", "LOAD", "LOCAL", "LOCK", "LOCKS", "LOGS", "LOW_PRIORITY", "MARIA", "MASTER", "MASTER_CONNECT_RETRY", "MASTER_HOST", "MASTER_LOG_FILE", "MATCH", "MAX_CONNECTIONS_PER_HOUR", "MAX_QUERIES_PER_HOUR", "MAX_ROWS", "MAX_UPDATES_PER_HOUR", "MAX_USER_CONNECTIONS", "MEDIUM", "MERGE", "MINUTE", "MINUTE_SECOND", "MIN_ROWS", "MODE", "MODIFY", "MONTH", "MRG_MYISAM", "MYISAM", "NAMES", "NATURAL", "NOT", "NOW()", "NULL", "OFFSET", "ON DELETE", "ON UPDATE", "ONLY", "OPEN", "OPTIMIZE", "OPTION", "OPTIONALLY", "OUTFILE", "PACK_KEYS", "PAGE", "PARTIAL", "PARTITION", "PARTITIONS", "PASSWORD", "PRIMARY", "PRIVILEGES", "PROCEDURE", "PROCESS", "PROCESSLIST", "PURGE", "QUICK", "RAID0", "RAID_CHUNKS", "RAID_CHUNKSIZE", "RAID_TYPE", "RANGE", "READ", "READ_ONLY", "READ_WRITE", "REFERENCES", "REGEXP", "RELOAD", "RENAME", "REPAIR", "REPEATABLE", "REPLACE", "REPLICATION", "RESET", "RESTORE", "RESTRICT", "RETURN", "RETURNS", "REVOKE", "RLIKE", "ROLLBACK", "ROW", "ROWS", "ROW_FORMAT", "SECOND", "SECURITY", "SEPARATOR", "SERIALIZABLE", "SESSION", "SHARE", "SHOW", "SHUTDOWN", "SLAVE", "SONAME", "SOUNDS", "SQL", "SQL_AUTO_IS_NULL", "SQL_BIG_RESULT", "SQL_BIG_SELECTS", "SQL_BIG_TABLES", "SQL_BUFFER_RESULT", "SQL_CACHE", "SQL_CALC_FOUND_ROWS", "SQL_LOG_BIN", "SQL_LOG_OFF", "SQL_LOG_UPDATE", "SQL_LOW_PRIORITY_UPDATES", "SQL_MAX_JOIN_SIZE", "SQL_NO_CACHE", "SQL_QUOTE_SHOW_CREATE", "SQL_SAFE_UPDATES", "SQL_SELECT_LIMIT", "SQL_SLAVE_SKIP_COUNTER", "SQL_SMALL_RESULT", "SQL_WARNINGS", "START", "STARTING", "STATUS", "STOP", "STORAGE", "STRAIGHT_JOIN", "STRING", "STRIPED", "SUPER", "TABLE", "TABLES", "TEMPORARY", "TERMINATED", "THEN", "TO", "TRAILING", "TRANSACTIONAL", "TRUE", "TRUNCATE", "TYPE", "TYPES", "UNCOMMITTED", "UNIQUE", "UNLOCK", "UNSIGNED", "USAGE", "USE", "USING", "VARIABLES", "VIEW", "WITH", "WORK", "WRITE", "YEAR_MONTH"];

	var reservedToplevelWords = ["AFTER", "DELETE FROM", "EXCEPT", "FETCH FIRST", "FROM", "GROUP BY", "GO", "HAVING", "INSERT INTO", "INSERT", "INTERSECT", "LIMIT", "MODIFY", "ORDER BY", "SELECT", "SET CURRENT SCHEMA", "SET SCHEMA", "SET", "UNION ALL", "UNION", "UPDATE", "VALUES", "WHERE"];

	var reservedNewlineWords = ["AND", "CROSS APPLY", "CROSS JOIN", "INNER JOIN", "JOIN", "LEFT JOIN", "LEFT OUTER JOIN", "OUTER APPLY", "OUTER JOIN", "ON", "RIGHT JOIN", "RIGHT OUTER JOIN", "XOR"];
	...
	var StandardSqlFormatter = function () {
	    ...
	    StandardSqlFormatter.prototype.format = function format(query) {
	        ...
	        if (this.cfg.custom) {
	            this.cfg.custom.forEach(function (custom) {
	                formatQuery = formatQuery.replace(custom.regex, function (match) {
	                    var uniqueId = (0, _uniqueId3["default"])('custom_unique_');
	                    customMap[uniqueId] = {
	                        match: match,
	        ...
	        formatQuery = new _Formatter2["default"](this.cfg, tokenizer).format(formatQuery);
	        if (this.cfg.custom && customMap) {
	            // reserved的目的是，先将id值大的先进行替换。如unique_11会被unique_1匹配到。导致bug
	            var entries = Object.entries(customMap).reverse();
	            entries.forEach(function (custom) {
	                if (typeof custom[1].replacer === 'function') {
	                    formatQuery = formatQuery.replace(new RegExp(custom[0], 'g'), function () {
	                        return custom[1].replacer(custom[1].match);
	                    });
	                } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayReduce = __webpack_require__(50),
	    deburr = __webpack_require__(106),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(42),
	    ...
	    Promise = __webpack_require__(46),
	    Set = __webpack_require__(47),
	    WeakMap = __webpack_require__(48),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var asciiToArray = __webpack_require__(51),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deburrLetter = __webpack_require__(70),
	    toString = __webpack_require__(2);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseRepeat = __webpack_require__(60),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseValues = __webpack_require__(64),
