 ...
 * 
 */
export const useStandardFormat = (keyword = '') => {
    const token = upperCase(keyword);
    // 不需要开启上下区块对齐的句首词，通常为DML、DDL相关
    const spaceByIndentTypesToken = ['CREATE', 'ALTER', 'ADD', 'DROP', 'UPDATE', 'DELETE', 'SHOW', 'SET'];
    // 需要开启对齐，通常为DQL
    const spaceWithAdditionalToken = ['SELECT', 'VALUES', 'FROM'];
